...
package unimelb.jf.sdk.language.parser;
...
public class PrologParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // logical_not | logical_and | arithmetic_eval | logical_equal
  ...
  public static boolean ident(PsiBuilder b, int l) {
    ...
    if (!nextTokenIs(b, "<ident>", ATOM, CONST)) return false;
    boolean r;
  ...
  /* ********************************************************** */
  // '=' primary
  public static boolean logical_equal(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "logical_equal")) return false;
    if (!nextTokenIs(b, EQUAL)) return false;
    boolean r;
    Marker m = enter_section_(b);
    r = consumeToken(b, EQUAL);
    r = r && primary(b, l + 1);
    exit_section_(b, m, LOGICAL_EQUAL, r);
    return r;
  }
  ...
  /* ********************************************************** */
  // (common_val_or_paren | logical_not | operator) (common_val_or_paren | equiv_binary | logical_or  | operator)*
  ...
  // common_val_or_paren | logical_not | operator
  ...
  // (common_val_or_paren | equiv_binary | logical_or  | operator)*
