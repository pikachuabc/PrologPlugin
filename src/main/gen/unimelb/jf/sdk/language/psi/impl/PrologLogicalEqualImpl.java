...
public class PrologLogicalEqualImpl extends ASTWrapperPsiElement implements PrologLogicalEqual {

  public PrologLogicalEqualImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PrologVisitor visitor) {
    visitor.visitLogicalEqual(this);
  }
